...
public class ClassFileParserTest {
	...
	public void testParseJava9Class() {
		JavaClass result = parseJava9Class("org/hjug/dtangler/javaengine/classfileparser", "SimpleJava9Class.class");
		assertEquals("SimpleJava9Class", result.getName());
		assertEquals("org.hjug.dtangler.javaengine.classfileparser", result.getPackage());
	}
	...
	private String getTestDataPackage() {
		return "org.hjug.dtangler.javaengine.classfileparser.testdata";
	}
